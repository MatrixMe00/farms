...
$(".animal").click(function(){
    ...
    $("#update").find("input[name=dob]").val($(this).find("span[data-dob]").attr("data-dob"))
    ...
    $("#update").find("input[name=birth_weight]").val($(this).find("span[data-b-weight]").attr("data-b-weight"))
    $("#update").find("input[name=sire_id]").val($(this).find("span[data-sire-id]").attr("data-sire-id"))
    $("#update").find("input[name=dam_id]").val($(this).find("span[data-dam-id]").attr("data-dam-id"))
